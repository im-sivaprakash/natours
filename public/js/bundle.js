        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Welcome dude !!');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'logout failed..!');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            (0, _alert.showAlert)('success', _context.t0.response.data.message);
...
var stripe = Stripe('ppk_test_vKJXjFcdexmhKTBcTMZvqLDj00a6HEFE5V');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(JSON.stringify(session)); // 2) Create checkout form + chanre credit card
...
var userDataSettings = document.querySelector('.form-user-settings');
var bookBtn = document.getElementById('book-tour');

if (mapbox) {
  var loc = JSON.parse(document.getElementById('map').dataset.locations);
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2l2YS1zdG9pYyIsImEiOiJjazhidzZrdW0wZ2dwM2xtamxybWRiYWF5In0.z4qEYuRNLRTNKM4tkKKQyg';
...
if (userDataSettings) userDataSettings.addEventListener('submit', /*#__PURE__*/function () {
